const birdsDataEn = {
  ...
  resultsDescription: "You've completed the quiz and scored {{score}} out of 30 possible points",
  resultFinishedDescription: "Game is over, you've completed the quiz with the maximum possible points",
  tryAgain: 'Try again',
  score: 'Score:',
  language: 'RU',
  nextLevel: 'Next level',
  descriptionText: 'Listen to the player. Select a bird from the list',
  greeting: 'Welcome to the BirdSong quiz',
  birds: [
    {
      question: 'Training',
      data: [
