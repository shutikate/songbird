const birdsDataRu = {
  ...
  descriptionText: 'Послушайте плеер. Выберите птицу из списка',
  congratulation: 'Поздравляем!',
  resultsDescription: 'Вы прошли викторину и набрали {{score}} из 30 возможных баллов',
  resultFinishedDescription: 'Игра окончена, вы набрали максимальное количество баллов',
  tryAgain: 'Попробовать еще раз',
  score: 'Счет:',
  greeting: 'Добро пожаловать на викторину<br>"Угадай пение птиц"',
  birds: [
    {
      question: 'Разминка',
      data: [
    ...
    },
    {
      ...
      data: [
        ...
        },
        {
          ...
          image: 'https://live.staticflickr.com/4534/26582090549_15a1b33e3c.jpg',
